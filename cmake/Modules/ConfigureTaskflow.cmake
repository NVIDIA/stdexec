...
if(STDEXEC_ENABLE_TASKFLOW)
  rapids_cpm_find(
    ...
    OPTIONS
    "TF_BUILD_TESTS OFF")
  file(GLOB_RECURSE taskflowexec_headers CONFIGURE_DEPENDS
       include/exec/taskflow/*.hpp)
  ...
  target_sources(
    ...
    PUBLIC FILE_SET
           ...
           include
           FILES
           ${taskflowexec_headers})
  target_compile_definitions(taskflowexec INTERFACE STDEXEC_ENABLE_TASKFLOW)

  target_link_libraries(stdexec INTERFACE Taskflow)

  target_link_libraries(taskflowexec INTERFACE STDEXEC::stdexec)
endif()
