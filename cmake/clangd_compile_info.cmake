...
message(
  STATUS
    "Creating symlink from \"${compile_commands_file}\" to \"${compile_commands_link}\"..."
)
stdexec_execute_non_fatal_process(COMMAND "${CMAKE_COMMAND}" -E rm -f
                                  "${compile_commands_link}")
stdexec_execute_non_fatal_process(COMMAND "${CMAKE_COMMAND}" -E touch
