...
namespace exec {
  ...
  namespace __start_detached {
    ...
    struct __operation : __op_base<_Env> {
      ...
      static constexpr void
        ...
        auto __alloc = STDEXEC::__with_default(
          STDEXEC::get_allocator, std::allocator<__operation>())(__self->__env_);
  ...
  struct start_detached_t {
    template <class _Sender, class _Env>
    using __compl_domain_t = STDEXEC::__mcall<
      STDEXEC::__mwith_default_q<STDEXEC::__completion_domain_of_t, STDEXEC::indeterminate_domain<>>,
      STDEXEC::set_value_t,
      _Sender,
    ...
    void apply_sender(_CvSender&& __sndr, _Env&& __env = {}) const noexcept(false) {
      ...
      if constexpr (__start_detached::__use_submit<_CvSender, _Env>) {
        ...
        STDEXEC::__submit::__submit(
          static_cast<_CvSender&&>(__sndr), __start_detached::__submit_receiver{});
      } else
#endif
      {
        // Use the provided allocator if any to allocate the operation state.
        auto __alloc =
          STDEXEC::__with_default(STDEXEC::get_allocator, std::allocator<__opstate_t>())(__env);
        using __alloc_t = decltype(__alloc);
        ...
        STDEXEC::__scope_guard __g{[__op, &__op_alloc]() noexcept {
        ...
        std::allocator_traits<__op_alloc_t>::construct(
