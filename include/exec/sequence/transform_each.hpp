...
namespace experimental::execution
{
  ...
  namespace __transform_each
  {
    ...
    struct __receiver
    {
      ...
      {
        return exec::set_next(__opstate_->__rcvr_,
                              __opstate_->__adaptor_(static_cast<_Item&&>(__item)));
      }
    ...
    struct __operation : __operation_base<_Receiver, _Adaptor>
    {
      __operation(_Sender&& __sndr, _Receiver __rcvr, _Adaptor __adaptor)
        : __operation_base<_Receiver, _Adaptor>{static_cast<_Receiver&&>(__rcvr),
                                                static_cast<_Adaptor&&>(__adaptor)}
        , __opstate_{
            exec::subscribe(static_cast<_Sender&&>(__sndr), __receiver<_Receiver, _Adaptor>{this})}
      {}
