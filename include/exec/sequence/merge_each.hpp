...
namespace experimental::execution
{
  namespace __merge_each
  {
    ...
    inline static constexpr __env_with_inplace_stop_token_t __env_with_inplace_stop_token;

    template <class _Env>
    using __env_with_inplace_stop_token_result_t =
      decltype(__env_with_inplace_stop_token(STDEXEC::__declval<STDEXEC::inplace_stop_source&>(),
    ...
    struct __nested_stop
    {
      ...
      void register_token(_Receiver& __receiver) noexcept
      {
        if constexpr (!unstoppable_token<__stop_token_t>)
        {
          ...
          __on_stop_.emplace(get_stop_token(STDEXEC::get_env(__receiver)),
                             __on_stop_request{__stop_source_});
        }
      }
    ...
    struct __error_sender
    {
      ...
      {
        using __result_t =
          STDEXEC::__mapply<STDEXEC::__mtransform<STDEXEC::__q<__error_signature_t>,
          ...
          case __completion_t::__error:
            if (__ex_ != nullptr)
            {
              ...
              STDEXEC::set_error(static_cast<_Receiver&&>(__rcvr_),
                                 static_cast<std::exception_ptr&&>(__ex_));
            }
            else
            {
              // forward error from the nested sequences as the last item
              if constexpr (__nothrow_callable<exec::set_next_t, _Receiver&, __error_sender_t>
                            && __nothrow_connectable<__error_next_sender_t,
                                                     __error_next_receiver_t>)
              {
                auto __next_sender   = exec::set_next(__rcvr_, __error_sender_t{this});
                auto __next_receiver = __error_next_receiver_t{
                  this,
                  __env_fn_t{&__rcvr_, &__nested_stop_}
                };
                __error_op_.__emplace_from(
                  [&]()
                  {
                    return STDEXEC::connect(static_cast<__error_next_sender_t&&>(__next_sender),
                                            static_cast<__error_next_receiver_t&&>(
                                              __next_receiver));
                  });
    ...
    struct __receive_nested_value
    {
      ...
      {
        auto __op = __op_;
        STDEXEC::set_value(static_cast<_NestedValueReceiver&&>(__nested_value_op_->__rcvr_),
    ...
    template <class _NestedValueSender,
    ...
    struct __nested_value_op : __nested_value_operation_base<_NestedValueReceiver>
    {
      ...
      __nested_value_op(_NestedValueReceiver          __rcvr,
                        _NestedValueSender            __result,
                        __operation_base_interface_t* __op)
        noexcept(__nothrow_move_constructible<_NestedValueReceiver>
                 && __nothrow_connectable<_NestedValueSender, __receiver>)
        : __base_t{static_cast<_NestedValueReceiver&&>(__rcvr)}
        , __nested_value_op_{STDEXEC::connect(static_cast<_NestedValueSender&&>(__result),
    ...
    using __nested_value_op_t = STDEXEC::__minvoke_q<
      ...
      _ErrorStorage,
      __minvoke_q<STDEXEC::connect_result_t,
                  _NestedValueSender,
    ...
    struct __nested_value_sender
    {
      ...
      STDEXEC_EXPLICIT_THIS_BEGIN(auto connect)(this _Self&& __self, _NestedValueReceiver&& __rcvr)
        noexcept(__nothrow_constructible_from<__nested_value_op_t<_NestedValueReceiver>,
                                              _NestedValueReceiver,
                                              _NestedValueSender,
    ...
    struct __receive_nested_values
    {
      ...
      {
        return exec::set_next(__op_->__rcvr_,
                              __nested_value_sender_t<_NestedValue>{static_cast<_NestedValue&&>(
                                                                      __nested_value),
                                                                    __op_});
      }
    ...
    struct __compute
    {
      ...
      {
        template <class... _Senders>
        using __f = __minvoke_if_c<__arg_of_base_t<_Env...>::template __valid_args<_Senders...>(),
      ...
      struct __all_nested_values_fn
      {
        ...
        using __f = STDEXEC::__minvoke<STDEXEC::__mconcat<STDEXEC::__qq<STDEXEC::__mlist>>,
      ...
      using __error_types_t =
        __mapply<STDEXEC::__mtransform<__error_types_fn<_Env...>,
      ...
      struct __nested_values_fn
      {
        ...
        using __f = __minvoke<__munique<STDEXEC::__q<item_types>>,
                              __merge_each::__nested_value_sender_t<_AllItems, _ErrorStorage>...,
                              __merge_each::__error_sender_t<_ErrorStorage>>;
      };

      template <class _Sequence, class... _Env>
      using __nested_values_t =
        __mapply<__nested_values_fn<__error_variant_t<_Sequence, _Env...>, _Env...>,
      ...
      using __nested_sequence_ops_variant = __mapply<
        STDEXEC::__mtransform<__nested_sequence_op_fn<__operation_base_t<_Sequence, _Receiver>>,
                              STDEXEC::__qq<STDEXEC::__uniqued_variant>>,
        __nested_sequences_t<_Sequence,
    ...
    struct __next_sequence_op : __next_operation_base<_NextReceiver, _OperationBase, _NestedSeqOp>
    {
      ...
      __next_sequence_op(_NextReceiver         __rcvr,
                         _OperationBase*       __op,
        ...
        , __op_(__op)
        , __nested_sequence_op_{
            STDEXEC::connect(static_cast<_NestedSequenceSender&&>(__nested_sequence),
    ...
    struct __next_sequence_sender
    {
      ...
      STDEXEC_EXPLICIT_THIS_BEGIN(auto connect)(this _Self&& __self, _NextReceiver&& __rcvr)
        noexcept(__nothrow_constructible_from<__next_sequence_op_t<_NextReceiver>,
                                              _NextReceiver,
                                              _OperationBase*,
    ...
    struct __receive_nested_sequences
    {
      ...
      auto set_next(_NestedSequenceSender&& __nested_sequence)
        noexcept(__nothrow_constructible_from<__next_sequence_sender_t<_NestedSequenceSender>,
                                              _OperationBase*,
    ...
    using __operation_t = __minvoke_q<
      ...
      _Receiver,
      _Sequence,
      __compute::__error_variant_t<_Sequence,
    ...
    struct __subscribe_fn
    {
        ...
        -> __opstate_t<_Sequence>
      {
        ...
        {
          return __opstate_t<_Sequence>{static_cast<_Receiver&&>(__rcvr_),
    ...
    struct merge_each_t
    {
      ...
      template <class _Self, class... _Env>
      using __completions_t = __mapply<__completions_fn<_Self, _Env...>,
      ...
      static consteval auto get_completion_signatures()
      {
        ...
        if constexpr (__ok<__result_t>)
        {
          static_assert(STDEXEC::__well_formed_completions<__result_t>);
          return __result_t();
        }
        else
        {
