...
namespace exec {
    ...
    namespace __next {
      ...
      struct __receiver_ref<completion_signatures<_Sigs...>, _Queries...> {
        struct __t {
          ...
          friend const __env_t& tag_invoke(get_env_t, _Self&& __self) noexcept {
  ...
  class any_sequence_receiver_ref {
   ...
   public:
    ...
    template <stdexec::__decays_to<any_sequence_receiver_ref> _Self>
    friend __env_t tag_invoke(stdexec::get_env_t, _Self&& __self) noexcept {
    ...
    using __env_base = stdexec::__t< __any::__sender_env<
     ...
     public:
      ...
      template <stdexec::same_as<stdexec::get_env_t> _GetEnv, stdexec::__decays_to<any_sender> _Self>
      friend __env_base tag_invoke(_GetEnv, _Self&& __self) noexcept {
