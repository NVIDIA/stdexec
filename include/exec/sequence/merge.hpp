  ...
  namespace __merge
  {
    ...
    struct __operation : __operation_base<_Receiver>
    {
      ...
      explicit __operation(_Receiver __rcvr, _Sequences... __sequences)
        ...
        , __op_result_{
            STDEXEC::connect(STDEXEC::when_all(exec::ignore_all_values(
                               exec::transform_each(static_cast<_Sequences&&>(__sequences),
     ...
     private:
      struct __subscribe_fn
      {
        ...
        auto operator()(_Receiver& __rcvr, __ignore, __ignore, _Sequences... __sequences)
          noexcept(__nothrow_decay_copyable<_Sequences...>) -> __operation<_Receiver, _Sequences...>
        {
          return __operation<_Receiver, _Sequences...>{static_cast<_Receiver&&>(__rcvr),
