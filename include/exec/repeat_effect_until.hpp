  ...
  namespace __repeat_effect_until {
    ...
    struct __operation {
      ...
      struct __t : stdexec::__immovable {
        ...
        STDEXEC_DEFINE_CUSTOM(void start)(this __t &__self, stdexec::start_t) noexcept {
    ...
    struct __sender {
      ...
      struct __t {
        ...
        STDEXEC_DEFINE_CUSTOM(auto get_env)(this const __t &__self, get_env_t) //
          noexcept -> __call_result_t<get_env_t, const _Source &> {
          return stdexec::get_env(__self.__source_);
        }
      };
    };
