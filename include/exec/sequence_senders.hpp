...
namespace experimental::execution
{
  ...
  namespace __sequence_sndr
  {
    ...
    struct get_item_types_t
    {
      ...
      template <class _Sequence, class _Env>
      constexpr auto operator()(_Sequence&&, _Env const &) const noexcept
      {
  ...
  template <class _Sequence, class... _Env>
  [[nodiscard]]
  constexpr auto get_item_types(_Sequence&&, _Env const &...)
  {
  ...
  constexpr auto __try_items(exec::item_types<_Items...>*)
    -> decltype((STDEXEC::__msuccess(),
                 ...,
  ...
  consteval auto __item_completion_signatures()
  {
    return exec::concat_completion_signatures(
      STDEXEC::completion_signatures<STDEXEC::set_value_t()>(),
      exec::transform_completion_signatures(STDEXEC::get_completion_signatures<_Sender, _Env...>(),
  ...
  consteval auto __sequence_completion_signatures()
  {
    return exec::concat_completion_signatures(
      ...
      exec::transform_completion_signatures(
        STDEXEC::get_completion_signatures<_Sequence, _Env...>(),
        exec::ignore_completion()));
  }
  ...
  consteval auto __sequence_completion_signatures_of()
  {
    ...
    else
    {
      return exec::concat_completion_signatures(
        ...
        __item_types.__transform(exec::__mk_item_transform<_Env...>(),
                                 exec::concat_completion_signatures));
    }
  }
  ...
  concept __stopped_means_break_receiver_from =  //
    !sequence_sender_in<_Sequence, STDEXEC::env_of_t<_Receiver>>
    && STDEXEC::__receiver_from<__sequence_sndr::__stopped_means_break<_Receiver>,
  ...
  namespace __sequence_sndr
  {
    ...
    template <class _Env>
    using __next_sender_completion_sigs_t =
    ...
    using __subscribe_member_result_t = decltype(__declval<_Sequence>().subscribe(
      __declval<_Receiver>()));
    ...
    struct subscribe_t
    {
     private:
      ...
      {
        static_assert(operation_state<_OpState>,
                      STDEXEC_ERROR_SUBSCRIBE_DOES_NOT_RETURN_OPERATION_STATE);
      }
      ...
      static consteval auto __get_declfn() noexcept
      {
        ...
        {
          using __result_t = connect_result_t<next_sender_of_t<_Receiver, __tfx_seq_t>,
                                              __stopped_means_break<_Receiver>>;
          __check_operation_state<__result_t>();
          constexpr bool __nothrow_subscribe =
            __nothrow_connectable<next_sender_of_t<_Receiver, __tfx_seq_t>,
                                  __stopped_means_break<_Receiver>>;
        ...
        else if constexpr (__subscribable_with_member<__tfx_seq_t, _Receiver>)
        {
          ...
          __check_operation_state<__result_t>();
          constexpr bool __nothrow_subscribe = noexcept(
            __declval<__tfx_seq_t>().subscribe(__declval<_Receiver>()));
          return __declfn<__result_t, __nothrow_subscribe && __nothrow_tfx_seq>();
        }
  ...
  namespace __debug
  {
    ...
    using __sequence_receiver_t = STDEXEC::__mapply<
      STDEXEC::__mtransform<
        STDEXEC::__mcompose<STDEXEC::__q1<std::remove_pointer_t>,
      ...
      if constexpr (!STDEXEC::__is_debug_env<_Env>)
      {
        if constexpr (sequence_sender_in<_CvSequence, _Env>)
        {
          ...
          if constexpr (STDEXEC::__not_same_as<__item_types_t, __debug::__item_types>)
          {
            ...
            {
              if (STDEXEC::__mnever<_CvSequence>)
              {  // never true
