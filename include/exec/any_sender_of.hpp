...
namespace exec {
  namespace __any {
    ...
    template <class _Query>
    using __is_never_stop_token_query_v = decltype(__test_never_stop_token(
      static_cast<_Query>(nullptr)));

    template <class _Query>
    concept __is_never_stop_token_query = __is_never_stop_token_query_v<_Query>::value;
      ...
      struct __ref<completion_signatures<_Sigs...>, _Queries...> {
       ...
       private:
        ...
        using _FilteredQueries =
          __minvoke<__mremove_if<__q<__is_never_stop_token_query_v>>, _Queries...>;
