...
namespace exec {
  namespace __task {
    ...
    template <class _ParentPromise>
    struct __default_awaiter_context {
      explicit __default_awaiter_context(__default_task_context_impl&, _ParentPromise&) noexcept {
      }
    };
    ...
    struct __default_awaiter_context<_ParentPromise> {
      ...
      explicit __default_awaiter_context(
        __default_task_context_impl& __self,
    ...
    struct __default_awaiter_context<void> {
      template <class _Ty>
      explicit __default_awaiter_context(__default_task_context_impl&, _Ty&) noexcept {
      }
