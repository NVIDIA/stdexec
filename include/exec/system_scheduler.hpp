...
struct __exec_system_scheduler_impl : public __exec_system_scheduler_interface {
  ...
  __exec_system_sender_interface*
    bulk(__exec_system_bulk_shape __shp, __exec_system_bulk_function_object __fn) override;
...
struct __exec_system_sender_impl : public __exec_system_sender_interface {
  ...
  __exec_system_operation_state_interface*
    connect(__exec_system_receiver __recv) noexcept override {
...
struct __exec_system_bulk_operation_state_impl : public __exec_system_operation_state_interface {
  ...
  stdexec::__result_of<
    ...
    __exec_system_bulk_shape,
    __exec_system_bulk_function_object>
    __pool_operation_state_;
};
...
namespace exec {
  ...
  class system_scheduler {
   public:
    ...
    system_scheduler(__exec_system_scheduler_interface* __scheduler_interface)
  ...
  class system_sender {
   public:
    ...
    system_sender(__exec_system_sender_interface* __sender_impl)
  ...
  struct __bulk_recv {
    ...
    friend void tag_invoke(stdexec::set_value_t, __bulk_recv&& __self, __As&&... __as) noexcept {
      ...
      if (__sched) {
        ...
        __self.__state_.__os_ = __sender->connect(__exec_system_receiver{
