...
namespace experimental::execution
{
  ...
  {  // NOLINT(bugprone-crtp-constructor-accessibility)
   private:
    ...
    template <class... Ts>
    using _error_t = STDEXEC::_ERROR_<STDEXEC::_WHAT_(_diag_t),
    ...
    template <class Fn>
    using _completions = STDEXEC::__minvoke_if_c<STDEXEC::__nothrow_callable<Fn, _probe_fn>,
   ...
   public:
    ...
    auto operator()(Fn fn) const noexcept
    {
      ...
      {
        static_assert(STDEXEC::__callable<Fn, _probe_fn>,
                      "The function passed to just_from, just_error_from, and just_stopped_from "
                      "must be "
