 ...
 *
 * This file duplicates github.com/josuttis/jthread/blob/master/source/stop_token.hpp
 * Apart from extending the file with the current header, no changes were made.
 */
#pragma once
// <stop_token> header
