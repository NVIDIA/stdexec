...
namespace STDEXEC
{
  ...
  namespace __cmplsigs
  {
    ...
    template <auto _Info>
      requires __same_as<decltype(_Info), __completion_info>
    ...
    template <auto _Info>
      requires std::ranges::forward_range<decltype(_Info)>
              && __same_as<std::ranges::range_value_t<decltype(_Info)>, __completion_info>
