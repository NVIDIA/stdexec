...
#define STDEXEC_REPEAT_2(_MACRO, ...)  STDEXEC_REPEAT_1(_MACRO, __VA_ARGS__) _MACRO(1 __VA_OPT__(,) __VA_ARGS__)
#define STDEXEC_REPEAT_3(_MACRO, ...)  STDEXEC_REPEAT_2(_MACRO, __VA_ARGS__) _MACRO(2 __VA_OPT__(,) __VA_ARGS__)
#define STDEXEC_REPEAT_4(_MACRO, ...)  STDEXEC_REPEAT_3(_MACRO, __VA_ARGS__) _MACRO(3 __VA_OPT__(,) __VA_ARGS__)
#define STDEXEC_REPEAT_5(_MACRO, ...)  STDEXEC_REPEAT_4(_MACRO, __VA_ARGS__) _MACRO(4 __VA_OPT__(,) __VA_ARGS__)
#define STDEXEC_REPEAT_6(_MACRO, ...)  STDEXEC_REPEAT_5(_MACRO, __VA_ARGS__) _MACRO(5 __VA_OPT__(,) __VA_ARGS__)
#define STDEXEC_REPEAT_7(_MACRO, ...)  STDEXEC_REPEAT_6(_MACRO, __VA_ARGS__) _MACRO(6 __VA_OPT__(,) __VA_ARGS__)
#define STDEXEC_REPEAT_8(_MACRO, ...)  STDEXEC_REPEAT_7(_MACRO, __VA_ARGS__) _MACRO(7 __VA_OPT__(,) __VA_ARGS__)
#define STDEXEC_REPEAT_9(_MACRO, ...)  STDEXEC_REPEAT_8(_MACRO, __VA_ARGS__) _MACRO(8 __VA_OPT__(,) __VA_ARGS__)
#define STDEXEC_REPEAT_10(_MACRO, ...) STDEXEC_REPEAT_9(_MACRO, __VA_ARGS__) _MACRO(9 __VA_OPT__(,) __VA_ARGS__)
