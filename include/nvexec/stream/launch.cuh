...
namespace nv::execution
{
  namespace _strm
  {
    ...
    namespace _launch
    {
      ...
      class receiver : public stream_receiver_base
      {
       ...
       public:
        ...
        void set_value(Args&&... args) noexcept
        {
          ...
          _launch_kernel<Args&...>
            <<<p.grid_size, p.block_size, p.shared_memory, stream>>>(std::move(fun_),
                                                                     stream,
                                                                     args...);
      ...
      template <class Fun, class... Args>
      using _set_value_t =
        __minvoke<__if_c<__callable<Fun, cudaStream_t, Args&...>,
      ...
      using completions_t =
        transform_completion_signatures<__completion_signatures_of_t<CvSender, Env...>,
