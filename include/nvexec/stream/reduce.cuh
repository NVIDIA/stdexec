  ...
  namespace STDEXEC_STREAM_DETAIL_NS {
    namespace reduce_ {
      ...
      struct __operation {
        ...
        using __receiver_id = receiver_t<_CvrefSender, _ReceiverId, _Shape, _Fun>;
      ...
      struct sender_t
        ...
        static_assert(stdexec::sender<sender_t<stdexec::__id<__decay_t<SenderId>>, InitT, Fun>>, "failed");  
      ...
      static auto get_completion_signatures(_Sender&& __sndr, _Env&&) {
        return __sender_apply(
          (_Sender&&) __sndr, []<class _Data, class _Child>(reduce_t, _Data, _Child&&) {
            using _Shape =
              decltype(_Data::__shape_); // should this be named _shape for consistency? Or InitT
