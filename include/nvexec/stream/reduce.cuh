...
template <class SenderId, class ReceiverId, class BoundRange, class BoundFun>
  ...
  class receiver_t : public receiver_base_t {
    ...
    template <class... As>
      using result_size_for_t = stdexec::__index<sizeof(reduce_result_t<BoundRange, BoundFun, As...>)>;
  ...
  public:
    ...
    // Range and function are bound.
    friend void tag_invoke(stdexec::set_value_t, receiver_t&& self) noexcept
    ...
    template <stdexec::__movable_value Fun>
      ...
      friend void tag_invoke(stdexec::set_value_t, receiver_t&& self, Fun&& fun) noexcept {
    ...
    template <ranges::range Range>
      ...
      friend void tag_invoke(stdexec::set_value_t, receiver_t&& self, Range&& rng) noexcept {
    ...
    template <ranges::range Range, stdexec::__movable_value Fun>
      friend void tag_invoke(stdexec::set_value_t, receiver_t&& self, Range&& rng, Fun&& fun) noexcept {
...
template <class SenderId, class BoundRangeId, class BoundFunId>
  struct reduce_sender_t : gpu_sender_base_t {
    using Sender = stdexec::__t<SenderId>;
    using BoundRange = stdexec::__t<BoundRangeId>;
    using BoundFun = stdexec::__t<BoundFunId>;
    ...
    template <class Receiver>
      using receiver_t = reduce_::receiver_t<SenderId, stdexec::__x<Receiver>, BoundRange, BoundFun>;
...
struct reduce_t {
  template <class Sender, class BoundRange, class BoundFun>
    using sender_t = reduce_sender_t<
      stdexec::__x<::cuda::std::remove_cvref_t<Sender>>,
      stdexec::__x<::cuda::std::remove_cvref_t<BoundRange>>,
      stdexec::__x<::cuda::std::remove_cvref_t<BoundFun>>
    >;
