  ...
  namespace STDEXEC_STREAM_DETAIL_NS {
    ...
    struct multi_gpu_stream_scheduler {
      ...
      struct operation_state_t : stream_op_state_base {
        ...
        STDEXEC_DEFINE_CUSTOM(void start)(this operation_state_t& op, start_t) noexcept {
      ...
      struct sender_t : stream_sender_base {
        ...
        STDEXEC_DEFINE_CUSTOM(const env& get_env)(this const sender_t& self, get_env_t) noexcept {
          return self.env_;
        }
