...
namespace std::execution {
  ...
  inline namespace __env {
    namespace __impl {
      ...
      template <__class _Tag, class _Value, class _BaseEnvId = __x<__empty_env>>
        ...
        struct __env {
          ...
          // Forward unknown contextual queries:
      ...
      template <__class _Tag>
        struct __make_env_t {
          template <class _Value>
            __env<_Tag, _Value> operator()(_Value __value) const
              noexcept(is_nothrow_copy_constructible_v<unwrap_reference_t<_Value>>) {
          ...
          template <class _Value, class _BaseEnv>
            auto operator()(_Value __value, _BaseEnv __base_env) const
              -> __env<_Tag, _Value, __x<_BaseEnv>> {
    ...
    // For making an evaluation context from a key/value pair, and optionally
    // another context.
    template <__class _Tag>
      inline constexpr __impl::__make_env_t<_Tag> __make_env {};
  } // namespace __env

  template <__class _Tag, class _Value, class _BaseEnv = __empty_env>
    using __make_env_t =
      decltype(__make_env<_Tag>(__declval<_Value>(), __declval<_BaseEnv>()));
  ...
  // doesn't change its metadata when used within a particular environment.
  template <class _Sender, class _Env = no_env>
    using sender_traits_t =
  ...
  template <class _Sender, class _Env = no_env>
    using __single_sender_value_t =
      value_types_of_t<_Sender, _Env, __single_or_void_t, __single_t>;
  ...
  /////////////////////////////////////////////////////////////////////////////
  // [execution.queries], general contextual queries
  ...
  inline namespace __connect_awaitable_ {
    namespace __impl {
      ...
      template <class _ReceiverId, class _EnvId>
        struct __promise;

      template <class _ReceiverId, class _EnvId>
        struct __operation : __operation_base {
          using promise_type = __promise<_ReceiverId, _EnvId>;
      ...
      template <class _ReceiverId, class _EnvId>
        struct __promise : __promise_base {
          ...
          template <class _T0>
          explicit __promise(_T0&, _Receiver& __rcvr, const _Env& __env) noexcept
            : __rcvr_(__rcvr)
            , __env_(__env)
          {}
          ...
          __operation<_ReceiverId, _EnvId> get_return_object() noexcept {
            return __operation<_ReceiverId, _EnvId>{
      ...
      template <class _Receiver, class _Env>
        using __promise_t =
          __promise<__x<remove_cvref_t<_Receiver>>, __x<remove_cvref_t<_Env>>>;

      template <class _Receiver, class _Env>
        using __operation_t =
          __operation<__x<remove_cvref_t<_Receiver>>, __x<remove_cvref_t<_Env>>>;
    } // namespace __impl
    ...
    inline constexpr struct __fn {
     private:
      ...
      template <class _Awaitable, class _Receiver, class _Env>
      static __impl::__operation_t<_Receiver, _Env>
      __co_impl(_Awaitable __await, _Receiver __rcvr, _Env __env) {
        using __result_t =
          __await_result_t<_Awaitable, __impl::__promise_t<_Receiver, _Env>>;
     ...
     public:
      template <class _Awaitable, receiver _Receiver, class _Env>
        requires __awaitable<_Awaitable, __impl::__promise_t<_Receiver, _Env>> &&
          receiver_of<_Receiver, __await_result_t<_Awaitable, __impl::__promise_t<_Receiver, _Env>>>
      __impl::__operation_t<_Receiver, _Env>
      operator()(_Awaitable&& __await, _Receiver&& __rcvr, _Env&& __env) const {
        return __co_impl((_Awaitable&&) __await, (_Receiver&&) __rcvr, (_Env&&) __env);
      }
      template <class _Awaitable, receiver _Receiver, class _Env>
        requires __awaitable<_Awaitable, __impl::__promise_t<_Receiver, _Env>> &&
          same_as<void, __await_result_t<_Awaitable, __impl::__promise_t<_Receiver, _Env>>> &&
  ...
  inline namespace __connect {
    template <class _Receiver, class _Env>
      using __connect_awaitable_promise_t =
        __connect_awaitable_::__impl::__promise_t<_Receiver, _Env>;

    inline constexpr struct connect_t {
      template <sender _Sender, receiver _Receiver, class _Env>
        requires tag_invocable<connect_t, _Sender, _Receiver, _Env> &&
          operation_state<tag_invoke_result_t<connect_t, _Sender, _Receiver, _Env>>
      auto operator()(_Sender&& __sndr, _Receiver&& __rcvr, _Env&& __env) const
        noexcept(nothrow_tag_invocable<connect_t, _Sender, _Receiver, _Env>)
        -> tag_invoke_result_t<connect_t, _Sender, _Receiver, _Env> {
        return tag_invoke(connect_t{}, (_Sender&&) __sndr, (_Receiver&&) __rcvr, (_Env&&) __env);
      }
      template <class _Awaitable, receiver _Receiver, class _Env>
        requires (!tag_invocable<connect_t, _Awaitable, _Receiver, _Env>) &&
           __awaitable<_Awaitable, __connect_awaitable_promise_t<_Receiver, _Env>>
      auto operator()(_Awaitable&& __await, _Receiver&& __rcvr, _Env&& __env) const
        -> __connect_awaitable_::__impl::__operation_t<_Receiver, _Env> {
        return __connect_awaitable((_Awaitable&&) __await, (_Receiver&&) __rcvr, (_Env&&) __env);
      }
    } connect {};
  }

  template <class _Sender, class _Receiver, class _Env>
    using connect_result_t = __call_result_t<connect_t, _Sender, _Receiver, _Env>;

  template <class _Sender, class _Receiver, class _Env>
    concept __has_nothrow_connect =
      noexcept(connect(__declval<_Sender>(), __declval<_Receiver>(), __declval<_Env>()));
  ...
  template <class _Sender, class _Receiver, class _Env>
    concept sender_to =
      receiver<_Receiver> &&
      requires (_Sender&& __sndr, _Receiver&& __rcvr, _Env&& __env) {
        connect((_Sender&&) __sndr, (_Receiver&&) __rcvr, (_Env&&) __env);
      };
  ...
  inline namespace __as_awaitable {
    template <class _Promise>
      using env_of_t =
        remove_cvref_t<decltype(__declval<_Promise>().get_env())>;
    ...
    namespace __impl {
      ...
      struct __sender_awaitable
       ...
       private:
        ...
        connect_result_t<_Sender, __receiver, _Env> __op_state_;
       public:
        __sender_awaitable(_Sender&& sender, __coro::coroutine_handle<_Promise> __hcoro)
            noexcept(__has_nothrow_connect<_Sender, __receiver, _Env>)
          : __op_state_(
              connect(
                (_Sender&&) sender,
                __receiver{{&this->__result_, __hcoro}},
                __hcoro.promise().get_env()))
        {}
      ...
      template <class _Sender, class _Promise>
        concept __awaitable_sender =
          ...
          sender_to<_Sender, __receiver<_Sender, _Promise>, env_of_t<_Promise>> &&
          requires (_Promise& __promise) {
            { __promise.unhandled_done() } -> convertible_to<__coro::coroutine_handle<>>;
            { __promise.get_env() } -> __none_of<void, no_env>;
          };
    } // namespace __impl
  ...
  inline namespace __with_awaitable_senders {
    namespace __impl {
      struct __with_awaitable_senders_base {
        ...
        __empty_env get_env() const noexcept {
          return {};
        }
  ...
  inline namespace __submit_ {
    namespace __impl {
      template <class _SenderId, class _ReceiverId, class _EnvId>
        struct __operation {
          using _Sender = __t<_SenderId>;
          using _Receiver = __t<_ReceiverId>;
          using _Env = __t<_EnvId>;
          ...
          _Receiver __rcvr_;
          connect_result_t<_Sender, __receiver, _Env> __op_state_;
          __operation(_Sender&& __sndr, __decays_to<_Receiver> auto&& __rcvr, __decays_to<_Env> auto&& __env)
            : __rcvr_((decltype(__rcvr)) __rcvr)
            , __op_state_(connect((_Sender&&) __sndr, __receiver{this}, (decltype(__env)) __env))
          {}
        };
    } // namespace __impl
    ...
    inline constexpr struct __submit_t {
      template <sender _Sender, receiver _Receiver, class _Env>
        requires sender_to<_Sender, _Receiver, _Env>
      void operator()(_Sender&& __sndr, _Receiver&& __rcvr, _Env&& __env) const noexcept(false) {
        start((new __impl::__operation<__x<_Sender>, __x<decay_t<_Receiver>>, __x<decay_t<_Env>>> {
            (_Sender&&) __sndr, (_Receiver&&) __rcvr, (_Env&&) __env})->__op_state_);
      }
    } __submit {};
  } // namespace __submit_
  ...
  inline namespace __start_detached {
    ...
    // TODO: could accept an optional Env parameter that defaults to __empty_env
    inline constexpr struct start_detached_t {
      ...
      template <sender _Sender>
        requires (!tag_invocable<start_detached_t, _Sender>) &&
          sender_to<_Sender, __impl::__detached_receiver, __empty_env>
      void operator()(_Sender&& __sndr) const noexcept(false) {
        __submit((_Sender&&) __sndr, __impl::__detached_receiver{}, __empty_env{});
      }
    } start_detached {};
    ...
    namespace __impl {
      template <class _CPO, class... _Ts>
        struct __sender {
          ...
          friend auto tag_invoke(connect_t, const __sender& __sndr, _Receiver&& __rcvr, auto&&)
          ...
          template <receiver_of<_Ts...> _Receiver>
          friend auto tag_invoke(connect_t, __sender&& __sndr, _Receiver&& __rcvr, auto&&)
  ...
  namespace __tag_invoke_adaptors {
    ...
    template <class _Sender, class _Receiver, class _Env>
      concept __has_connect =
        requires(_Sender&& __sndr, _Receiver&& __rcvr, _Env&& __env) {
          ((_Sender&&) __sndr).connect((_Receiver&&) __rcvr, (_Env&&) __env);
        };
    ...
    template <__class _Derived, sender _Base>
      struct __sender_adaptor {
        class __t : __adaptor_base<_Base> {
          ...
          template <__decays_to<_Derived> _Self, receiver _Receiver, class _Env>
            requires __has_connect<_Self, _Receiver, _Env>
          friend auto tag_invoke(connect_t, _Self&& __self, _Receiver&& __rcvr, _Env&& __env)
            noexcept(noexcept(((_Self&&) __self).connect((_Receiver&&) __rcvr, (_Env&&) __env)))
            -> decltype(((_Self&&) __self).connect((_Receiver&&) __rcvr, (_Env&&) __env)) {
            return ((_Self&&) __self).connect((_Receiver&&) __rcvr, (_Env&&) __env);
          }

          template <__decays_to<_Derived> _Self, receiver _Receiver, class _Env>
            requires requires {typename decay_t<_Self>::connect;} &&
              sender_to<__member_t<_Self, _Base>, _Receiver, _Env>
          friend auto tag_invoke(connect_t, _Self&& __self, _Receiver&& __rcvr, _Env&& __env)
            noexcept(__has_nothrow_connect<__member_t<_Self, _Base>, _Receiver, _Env>)
            -> connect_result_t<__member_t<_Self, _Base>, _Receiver, _Env> {
            return execution::connect(((_Self&&) __self).base(), (_Receiver&&) __rcvr, (_Env&&) __env);
          }
    ...
    namespace __impl {
      ...
      template <class _SenderId, class _Fun>
        class __sender
          ...
          template <receiver _Receiver, class _Env>
            requires __invocable_with_values_from<_Fun, _Sender, _Env> &&
              sender_to<_Sender, __receiver<_Receiver>, _Env>
          auto connect(_Receiver&& __rcvr, _Env&& __env) &&
            noexcept(__has_nothrow_connect<_Sender, __receiver<_Receiver>, _Env>)
            -> connect_result_t<_Sender, __receiver<_Receiver>, _Env> {
  ...
  inline namespace __let {
    namespace __impl {
      ...
      template <class _SenderId, class _ReceiverId, class _EnvId, class _Fun, class _Let>
        struct __receiver;
      ...
      template <class _Sender, class _Receiver, class _Env, class _Fun, class _Let>
        struct __storage {
          any __args_;
          any __op_state3_;
        };
      ...
      template <class _Sender, class _Receiver, class _Env, class _Fun>
          requires typed_sender<_Sender, _Env>
        struct __storage<_Sender, _Receiver, _Env, _Fun, set_value_t> {
          template <class... _As>
            using __op_state_for_t =
              connect_result_t<__result_sender_t<_Fun, _As...>, _Receiver, _Env>;
          ...
          using __op_state3_t =
            __value_types_of_t<_Sender, _Env, __q<__op_state_for_t>, __nullable_variant_t>;
      ...
      template <class _Sender, class _Receiver, class _Env, class _Fun>
          requires typed_sender<_Sender, _Env>
        struct __storage<_Sender, _Receiver, _Env, _Fun, set_error_t> {
          template <class _Error>
            using __op_state_for_t =
              connect_result_t<__result_sender_t<_Fun, _Error>, _Receiver, _Env>;
      ...
      template <class _Sender, class _Receiver, class _Env, class _Fun>
        struct __storage<_Sender, _Receiver, _Env, _Fun, set_done_t> {
          variant<tuple<>> __args_;
          variant<monostate, connect_result_t<__call_result_t<_Fun>, _Receiver, _Env>> __op_state3_;
        };
        ...
        struct __receiver {
          ...
          template <__one_of<_Let> _Tag, class... _As>
              requires __applyable<_Fun, __which_tuple_t<_As...>&> &&
                sender_to<__apply_result_t<_Fun, __which_tuple_t<_As...>&>, _Receiver, _Env>
              ...
              start(__self.__op_state_->__storage_.__op_state3_.template emplace<__op_state_t>(
                __conv{[&] {
                  return connect(
                    ...
                    std::move(__self).base(),
                    std::move(__self.__op_state_->__env_));
                }}
              ));
            } catch(...) {
          ...
          __operation<_SenderId, _ReceiverId, _EnvId, _Fun, _Let>* __op_state_;
        };
      ...
      template <class _SenderId, class _ReceiverId, class _EnvId, class _Fun, class _Let>
        struct __operation {
          ...
          using _Receiver = __t<_ReceiverId>;
          using _Env = __t<_EnvId>;
          using __receiver_t = __receiver<_SenderId, _ReceiverId, _EnvId, _Fun, _Let>;

          friend void tag_invoke(start_t, __operation& __self) noexcept {
            start(__self.__op_state2_);
          }

          template <class _Receiver2, class _Env2>
            __operation(_Sender&& __sndr, _Receiver2&& __rcvr, _Env2&& __env, _Fun __fun)
              : __env_((_Env2&&) __env)
              , __op_state2_(connect((_Sender&&) __sndr, __receiver_t{this}, __env_))
              , __rcvr_((_Receiver2&&) __rcvr)
              , __fun_((_Fun&&) __fun)
            {}

          _Env __env_;
          connect_result_t<_Sender, __receiver_t, _Env&> __op_state2_;
          _Receiver __rcvr_;
          _Fun __fun_;
          [[no_unique_address]]
            __storage<_Sender, _Receiver, _Env, _Fun, _Let> __storage_;
        };
      ...
      template <class _SenderId, class _Fun, class _LetId, class _Which>
        struct __sender {
          ...
          template <class _Self, class _Receiver, class _Env>
            using __operation_t =
              __operation<
                __x<__member_t<_Self, _Sender>>,
                __x<remove_cvref_t<_Receiver>>,
                __x<remove_cvref_t<_Env>>,
                _Fun,
                _Let>;
          template <class _Self, class _Receiver, class _Env>
            using __receiver_t =
          ...
          template <__decays_to<__sender> _Self, receiver _Receiver, class _Env>
              ...
              sender_to<
                __member_t<_Self, _Sender>,
                __receiver_t<_Self, _Receiver, _Env>,
                decay_t<_Env>>
            friend auto tag_invoke(connect_t, _Self&& __self, _Receiver&& __rcvr, _Env&& __env)
              -> __operation_t<_Self, _Receiver, _Env> {
              return __operation_t<_Self, _Receiver, _Env>{
  ...
  inline namespace __done_as_xxx {
    namespace __impl {
      ...
      template <class _SenderId, class _ReceiverId, class _EnvId>
        struct __receiver
          : receiver_adaptor<__receiver<_SenderId, _ReceiverId, _EnvId>> {
          using _Sender = __t<_SenderId>;
          using _Receiver = __t<_ReceiverId>;
          using _Env = __t<_EnvId>;
          using _Value = __single_sender_value_t<_Sender, _Env>;
          ...
          template <__constructible_from<_Sender, _Env> _Ty>
          ...
          __operation<_SenderId, _ReceiverId, _EnvId>* __op_;
        };
      ...
      template <class _SenderId, class _ReceiverId, class _EnvId>
        struct __operation {
          ...
          using _Receiver = __t<_ReceiverId>;
          using _Env = __t<_EnvId>;
          using __receiver_t = __receiver<_SenderId, _ReceiverId, _EnvId>;

          template <class _Receiver2, class _Env2>
            __operation(_Sender&& __sndr, _Receiver2&& __rcvr, _Env2&& __env)
              : __op_state_(
                  connect(
                    (_Sender&&) __sndr,
                    __receiver_t{{}, this},
          ...
          connect_result_t<_Sender, __receiver_t, _Env> __op_state_;
          _Receiver __rcvr_;
        };
      ...
      template <class _SenderId>
        struct __sender {
          ...
          template <class _Self, class _Receiver, class _Env>
            using __operation_t =
              __operation<__x<__member_t<_Self, _Sender>>, __x<decay_t<_Receiver>>, __x<decay_t<_Env>>>;
          template <class _Self, class _Receiver, class _Env>
            using __receiver_t =
              __receiver<__x<__member_t<_Self, _Sender>>, __x<decay_t<_Receiver>>, __x<decay_t<_Env>>>;
          ...
          template <__decays_to<__sender> _Self, receiver _Receiver, class _Env>
              requires
                __single_typed_sender<__member_t<_Self, _Sender>, decay_t<_Env>> &&
                sender_to<
                  __member_t<_Self, _Sender>,
                  __receiver_t<_Self, _Receiver, _Env>,
                  _Env>
            friend auto tag_invoke(connect_t, _Self&& __self, _Receiver&& __rcvr, _Env&& __env)
              -> __operation_t<_Self, _Receiver, _Env> {
              return __operation_t<_Self, _Receiver, _Env>{
                ((_Self&&) __self).__sndr_, (_Receiver&&) __rcvr, (_Env&&) __env};
            }
  ...
  inline namespace __loop {
    ...
    namespace __impl {
      ...
      template <class _ReceiverId, class _StopToken>
        class __operation final : __task {
          ...
          [[no_unique_address]] _StopToken __stoken_;

         public:
          template <class _Receiver2>
          explicit __operation(_Receiver2&& __rcvr, run_loop* __loop, _StopToken __stoken)
            : __rcvr_((_Receiver2 &&) __rcvr)
            , __loop_(__loop)
            , __stoken_((_StopToken&&) __stoken) {}
        };
    } // namespace __impl
      ...
      class __scheduler {
        struct __schedule_task
         ...
         private:
          ...
          template <class _Receiver, class _Env>
          friend __impl::__operation<__x<decay_t<_Receiver>>, stop_token_of_t<_Env>>
          tag_invoke(connect_t, const __schedule_task& __self, _Receiver&& __rcvr, _Env&& __env) {
            return __impl::__operation<__x<decay_t<_Receiver>>, stop_token_of_t<_Env&>>{
                (_Receiver &&) __rcvr, __self.__loop_, get_stop_token(__env)};
          }
    ...
    namespace __impl {
      template <class _ReceiverId, class _StopToken>
      inline void __operation<_ReceiverId, _StopToken>::__start_() noexcept try {
  ...
  inline namespace __schedule_from {
    namespace __impl {
      ...
      template <class _SchedulerId, class _CvrefSenderId, class _ReceiverId, class _EnvId>
        struct __operation1;
      ...
      template <class _SchedulerId, class _CvrefSenderId, class _ReceiverId, class _EnvId>
        struct __receiver2 {
          using _Receiver = __t<_ReceiverId>;
          __operation1<_SchedulerId, _CvrefSenderId, _ReceiverId, _EnvId>* __op_state_;
      ...
      template <class _SchedulerId, class _CvrefSenderId, class _ReceiverId, class _EnvId>
        struct __receiver1 {
          ...
          using _Receiver = __t<_ReceiverId>;
          using __receiver2_t =
            __receiver2<_SchedulerId, _CvrefSenderId, _ReceiverId, _EnvId>;
          __operation1<_SchedulerId, _CvrefSenderId, _ReceiverId, _EnvId>* __op_state_;
          ...
          friend void tag_invoke(_Tag, __receiver1&& __self, _Args&&... __args) noexcept try {
            ...
            __self.__op_state_->__state2_.emplace(
                __conv{[__op_state = __self.__op_state_] {
                  return connect(
                    schedule(__op_state->__sched_),
                    __receiver2_t{__op_state},
                    std::move(__op_state->__env_));
                }});
      ...
      template <class _SchedulerId, class _CvrefSenderId, class _ReceiverId, class _EnvId>
        struct __operation1 {
          ...
          using _Env = __t<_EnvId>;
          using __receiver1_t =
            __receiver1<_SchedulerId, _CvrefSenderId, _ReceiverId, _EnvId>;
          using __receiver2_t =
            __receiver2<_SchedulerId, _CvrefSenderId, _ReceiverId, _EnvId>;
          ...
          __minvoke<__completion_storage<_CvrefSender, _Env>, _Receiver> __data_;
          connect_result_t<_CvrefSender, __receiver1_t, _Env&> __state1_;
          optional<connect_result_t<schedule_result_t<_Scheduler>, __receiver2_t, _Env>> __state2_;

          __operation1(_Scheduler __sched,
                       _CvrefSender&& __sndr,
                       __decays_to<_Receiver> auto&& __rcvr,
                       __decays_to<_Env> auto&& __env)
            : __sched_(__sched)
            , __rcvr_((decltype(__rcvr)) __rcvr)
            , __env_((decltype(__env)) __env)
            , __state1_(connect((_CvrefSender&&) __sndr, __receiver1_t{this}, __env_)) {}
      ...
      template <class _SchedulerId, class _SenderId>
        struct __sender {
          ...
          template <__decays_to<__sender> _Self, receiver _Receiver, class _Env>
            requires sender_to<__member_t<_Self, _Sender>, _Receiver, _Env>
          friend auto tag_invoke(connect_t, _Self&& __self, _Receiver&& __rcvr, _Env&& __env)
              -> __operation1<_SchedulerId, __x<__member_t<_Self, _Sender>>, __x<decay_t<_Receiver>>, __x<decay_t<_Env>>> {
            return {__self.__sched_, ((_Self&&) __self).__sndr_, (_Receiver&&) __rcvr, (_Env&&) __env};
          }
  ...
  inline namespace __on {
    namespace __impl {
      template <class _SchedulerId, class _SenderId, class _ReceiverId, class _EnvId>
        struct __operation;

      template <class _Scheduler, class _Env>
        using __env_t =
          __make_env_t<get_scheduler_t, _Scheduler, _Env>;

      template <class _SchedulerId, class _SenderId, class _ReceiverId, class _EnvId>
        struct __receiver_ref
          : receiver_adaptor<__receiver_ref<_SchedulerId, _SenderId, _ReceiverId, _EnvId>> {
          using _Scheduler = __t<_SchedulerId>;
          using _Sender = __t<_SenderId>;
          using _Receiver = __t<_ReceiverId>;
          __operation<_SchedulerId, _SenderId, _ReceiverId, _EnvId>* __op_state_;
      ...
      template <class _SchedulerId, class _SenderId, class _ReceiverId, class _EnvId>
        struct __receiver
          : receiver_adaptor<__receiver<_SchedulerId, _SenderId, _ReceiverId, _EnvId>> {
          using _Scheduler = __t<_SchedulerId>;
          using _Sender = __t<_SenderId>;
          using _Receiver = __t<_ReceiverId>;
          using __receiver_ref_t =
            __receiver_ref<_SchedulerId, _SenderId, _ReceiverId, _EnvId>;
          __operation<_SchedulerId, _SenderId, _ReceiverId, _EnvId>* __op_state_;
          _Receiver&& base() && noexcept {
            return (_Receiver&&) __op_state_->__rcvr_;
          }
      ...
      template <class _SchedulerId, class _SenderId, class _ReceiverId, class _EnvId>
        struct __operation {
          ...
          using _Sender = __t<_SenderId>;
          using _Receiver = __t<_ReceiverId>;
          using __env_t = __env_t<_Scheduler, __t<_EnvId>>;
          using __receiver_t =
            __receiver<_SchedulerId, _SenderId, _ReceiverId, _EnvId>;
          using __receiver_ref_t =
            __receiver_ref<_SchedulerId, _SenderId, _ReceiverId, _EnvId>;
          ...
          template <class _Sender2, class _Receiver2, class _Env2>
          __operation(_Scheduler __sched, _Sender2&& __sndr, _Receiver2&& __rcvr, _Env2&& __env)
            : __env_(__make_env<get_scheduler_t>((_Scheduler&&) __sched, (_Env2&&) __env))
          ...
          __env_t __env_;
          variant<
              connect_result_t<schedule_result_t<_Scheduler>, __receiver_t, __env_t&>,
              connect_result_t<_Sender, __receiver_ref_t, __env_t>> __data_;
          _Sender __sndr_;
          _Receiver __rcvr_;
        };
      ...
      template <class _SchedulerId, class _SenderId>
        struct __sender {
          ...
          template <class _ReceiverId, class _EnvId>
            using __operation_t =
              __operation<_SchedulerId, _SenderId, _ReceiverId, _EnvId>;
          ...
          template <__decays_to<__sender> _Self, receiver _Receiver, class _Env>
            requires constructible_from<_Sender, __member_t<_Self, _Sender>> &&
              sender_to<schedule_result_t<_Scheduler>,
                        __receiver_t<__x<decay_t<_Receiver>>, __x<decay_t<_Env>>>,
                        __env_t<_Scheduler, decay_t<_Env>>&> &&
              sender_to<_Sender,
                        __receiver_ref_t<__x<decay_t<_Receiver>>, __x<decay_t<_Env>>>,
                        __env_t<_Scheduler, decay_t<_Env>>>
          friend auto tag_invoke(connect_t, _Self&& __self, _Receiver&& __rcvr, _Env&& __env)
            -> __operation_t<__x<decay_t<_Receiver>>, __x<decay_t<_Env>>> {
  ...
  inline namespace __into_variant {
    namespace __impl {
      ...
      template <class _SenderId, class _ReceiverId, class _EnvId>
        class __receiver
          : receiver_adaptor<__receiver<_SenderId, _ReceiverId, _EnvId>, __t<_ReceiverId>> {
          using _Sender = __t<_SenderId>;
          using _Receiver = __t<_ReceiverId>;
          using _Env = __t<_EnvId>;
          friend receiver_adaptor<__receiver, _Receiver>;
      ...
      template <class _SenderId>
        struct __sender : sender_adaptor<__sender<_SenderId>, __t<_SenderId>> {
          ...
          template <class _Receiver, class _Env>
            using __receiver_t =
              __receiver<_SenderId, __x<remove_cvref_t<_Receiver>>, __x<remove_cvref_t<_Env>>>;

          template <receiver _Receiver, class _Env>
            requires __valid<__into_variant_result_t, _Sender, _Env> &&
              receiver_of<_Receiver, __into_variant_result_t<_Sender, _Env>> &&
              sender_to<_Sender, __receiver_t<_Receiver, _Env>, _Env>
          auto connect(_Receiver&& __rcvr, _Env&& __env) && noexcept(
            __has_nothrow_connect<_Sender, __receiver_t<_Receiver, _Env>, _Env>)
            -> connect_result_t<_Sender, __receiver_t<_Receiver, _Env>, _Env> {
            return execution::connect(
                ((__sender&&) *this).base(),
                __receiver_t<_Receiver, _Env>{(_Receiver&&) __rcvr},
                (_Env&&) __env);
          }
  ...
  inline namespace __when_all {
    namespace __impl {
      ...
      template <class _CvrefSender, class _Env, class _SingleOrVoid>
      ...
      template <class _Env>
        using __env_t =
          __make_env_t<get_stop_token_t, in_place_stop_token, _Env>;
      ...
      template <class... _SenderIds>
        struct __sender {
         ...
         private:
          template <class>
            struct __traits {};
          template <class _CvrefReceiverId, class _EnvId>
            struct __operation;

          template <class _CvrefReceiverId, class _EnvId, size_t _Index>
            struct __receiver
              : receiver_adaptor<__receiver<_CvrefReceiverId, _EnvId, _Index>> {
              using _WhenAll = __member_t<_CvrefReceiverId, __sender>;
              using _Receiver = __t<decay_t<_CvrefReceiverId>>;
              using _Traits = __traits<__env_t<__t<_EnvId>>>;
              ...
              __operation<_CvrefReceiverId, _EnvId>* __op_state_;
            };

          template <class _Variant, class _CvrefEnv>
            using __error_types =
              __minvoke<
          ...
          template <class _CvrefReceiverId, class _EnvId>
            struct __operation {
              ...
              using _Receiver = __t<decay_t<_CvrefReceiverId>>;
              using _Env = __t<_EnvId>;
              using __env_t = __env_t<_Env>;
              using __cvref_env_t = __member_t<_CvrefReceiverId, __env_t>;

              template <class _Sender, size_t _Index>
                using __child_op_state =
                  connect_result_t<
                    __member_t<_WhenAll, _Sender>,
                    __receiver<_CvrefReceiverId, _EnvId, _Index>,
                    __env_t>;
              ...
              template <size_t... _Is>
                static auto __connect_children(
                  ...
                  return tuple<__child_op_state<__t<_SenderIds>, _Is>...>{
                    __conv{[&__when_all, &__env, __self]() {
                      return execution::connect(
                          std::get<_Is>(((_WhenAll&&) __when_all).__sndrs_),
                          __receiver<_CvrefReceiverId, _EnvId, _Is>{{}, __self},
                          __env);
                    }}...
                  };
                }
              ...
              void __complete() noexcept {
                ...
                case __started:
                  if constexpr (__traits<__cvref_env_t>::__has_values) {
              ...
              __operation(_WhenAll&& __when_all, _Receiver __rcvr, _Env __env)
                : __child_states_{
                    __connect_children(
                      this,
                      (_WhenAll&&) __when_all,
                      __make_env<get_stop_token_t>(
                        __stop_source_.get_token(),
                        (_Env&&) __env),
                      _Indices{})
                  }
                , __recvr_((_Receiver&&) __rcvr)
                , __stoken_(get_stop_token(__env))
              {}
              ...
              using __child_values_tuple_t =
                typename __traits<__cvref_env_t>::template __value_types<
          ...
          template <__decays_to<__sender> _Self, receiver _Receiver, class _Env>
              requires __is_true<__can_connect_to_t<_Self, _Receiver, _Env>>
            friend auto tag_invoke(connect_t, _Self&& __self, _Receiver&& __rcvr, _Env&& __env)
              -> __operation<__member_t<_Self, __x<decay_t<_Receiver>>>, __x<decay_t<_Env>>> {
              return {
                (_Self&&) __self,
                (_Receiver&&) __rcvr,
                (_Env&&) __env};
  ...
  inline namespace __read_ {
    namespace __impl {
      template <class _Tag, class _ReceiverId, class _Value>
        struct __operation {
          __t<_ReceiverId> __rcvr_;
          _Value __value_;
          friend void tag_invoke(start_t, __operation& __self) noexcept try {
            set_value(std::move(__self.__rcvr_), std::move(__self.__value_));
          } catch(...) {
        ...
        struct __sender {
          template <receiver _Receiver, class _Env>
            requires __callable<_Tag, _Env> &&
              receiver_of<_Receiver, __call_result_t<_Tag, _Env>>
          friend auto tag_invoke(connect_t, __sender, _Receiver&& __rcvr, _Env&& __env)
            noexcept(is_nothrow_constructible_v<decay_t<_Receiver>, _Receiver>)
            -> __operation<_Tag, __x<decay_t<_Receiver>>, __call_result_t<_Tag, _Env>> {
            return {(_Receiver&&) __rcvr, _Tag{}((_Env&&) __env)};
          }
  ...
  inline namespace __sync_wait {
    namespace __impl {
      ...
      struct __env {
        ...
        friend auto tag_invoke(execution::get_delegee_scheduler_t, const __env& __self) noexcept
          -> execution::run_loop::__scheduler {
          return __self.__sched_;
        }
      };
      ...
      auto operator()(_Sender&& __sndr) const
        ...
        auto __op_state =
          execution::connect(
            ...
            __impl::__env{__loop.get_scheduler()});
