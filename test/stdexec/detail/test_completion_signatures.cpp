...
namespace
{
  ...
  TEST_CASE("set_value_sig can be used to transform value types to corresponding completion "
            "signatures",
  ...
  TEST_CASE("set_error_sig can be used to transform error types to corresponding completion "
            "signatures",
            "[detail][completion_signatures]")
  {
  ...
  TEST_CASE("set_error_sig can be used to transform exception_ptr",
            "[detail][completion_signatures]")
  {
    using set_error_f = ex::__q<set_error_sig>;
  ...
  TEST_CASE("__error_types_of_t gets the error types from sender",
            "[detail][completion_signatures]")
  {
  ...
  {
    using snd_t      = decltype(ex::when_all(ex::just_error(std::error_code{}),
  ...
  TEST_CASE("regression: error_types_of_t can be used to transform error types",
            "[detail][completion_signatures]")
  {
