...
namespace
{
  ...
  struct throwing_specials : crtp_association<throwing_specials>
  {
    ...
    throwing_specials(throwing_specials const &) noexcept(false)
    {
      // nvcc doesn't respect the noexcept(false) with = default
    }
    ...
    throwing_specials& operator=(throwing_specials const &) noexcept(false)
    {
      // nvcc doesn't respect the noexcept(false) with = default
      return *this;
    }
  ...
  TEST_CASE("Scope association concept accepts basic association types",
            "[concepts][scope_association]")
  {
    ...
    STATIC_REQUIRE(!ex::__nothrow_constructible_from<throwing_specials, throwing_specials const &>);
    STATIC_REQUIRE(!ex::__nothrow_assignable_from<throwing_specials, throwing_specials const &>);
  ...
  TEST_CASE("Scope association concept rejects non-association types",
            "[concepts][scope_association]")
  {
