...
namespace
{
            ...
            "[adaptors][into_variant]")
  {
    ...
    check_val_types<ex::__mset<pack<std::variant<std::tuple<int>>>>>(ex::just(23)
                                                                     | ex::into_variant());
    check_val_types<ex::__mset<pack<std::variant<std::tuple<double>>>>>(ex::just(std::numbers::pi)
                                                                        | ex::into_variant());
