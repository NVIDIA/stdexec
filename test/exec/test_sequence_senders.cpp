...
namespace
{
  ...
  TEST_CASE("sequence_senders - some_sender_of is a sender", "[sequence_senders]")
  {
    ...
    STATIC_REQUIRE(std::same_as<completion_signatures_of_t<some_sender_of<set_value_t()>>,
                                completion_signatures<set_value_t()>>);
    STATIC_REQUIRE(std::same_as<completion_signatures_of_t<some_sender_of<set_value_t(int)>>,
