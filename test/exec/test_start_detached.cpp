...
namespace
{
  ...
  struct custom_scheduler
  {
    ...
    [[nodiscard]]
    auto
    query(ex::get_completion_scheduler_t<Tag>, ex::__ignore = {}) const noexcept -> custom_scheduler
    {
      return *this;
    }
    ...
    auto operator==(custom_scheduler const &) const -> bool = default;
  ...
  struct counting_resource : std::pmr::memory_resource
  {
   ...
   private:
    ...
    [[nodiscard]]
    auto do_is_equal(memory_resource const & other) const noexcept -> bool override
    {
      return this == &other;
    }
