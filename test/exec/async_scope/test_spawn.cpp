...
namespace
{
  ...
  TEST_CASE("TODO: spawn will keep track on how many operations are in flight",
            "[async_scope][spawn]")
  {
    impulse_scheduler sch;
  ...
  TEST_CASE("TODO: spawn works with senders that complete with stopped signal",
            "[async_scope][spawn]")
  {
    impulse_scheduler sch;
    async_scope       scope;
