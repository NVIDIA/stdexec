...
namespace
{
  ...
  TEST_CASE("materialize completion signatures", "[adaptors][materialize]")
  {
    ...
    static_assert(set_equivalent<completion_signatures_of_t<decltype(just_)>,
                                 completion_signatures<set_value_t(set_value_t)>>);
    auto demat_just = dematerialize(just_);
    static_assert(set_equivalent<completion_signatures_of_t<decltype(demat_just)>,
    ...
    static_assert(std::same_as<completion_signatures_of_t<decltype(demat_just_string)>,
    ...
    static_assert(set_equivalent<completion_signatures_of_t<decltype(just_stopped_)>,
                                 completion_signatures<set_value_t(set_stopped_t)>>);
    auto demat_just_stopped = dematerialize(just_stopped_);
    static_assert(set_equivalent<completion_signatures_of_t<decltype(demat_just_stopped)>,
