...
namespace
{
  ...
  class flags_storage_t
  {
   ...
   public:
    ...
    flags_storage_t(flags_storage_t const &) = delete;
    flags_storage_t(flags_storage_t&&)       = delete;

    void operator()(flags_storage_t const &) = delete;
  ...
  namespace detail::a_sender
  {
    ...
    struct sender
    {
      ...
      STDEXEC_EXPLICIT_THIS_BEGIN(auto connect)(this Self&& self, Receiver&& rcvr)
        -> op_t<Self, Receiver>
      {
        return op_t<Self, Receiver>(static_cast<Self&&>(self).sndr_,
                                    receiver<Receiver, Fun>(static_cast<Receiver&&>(rcvr),
                                                            self.fun_));
      }
