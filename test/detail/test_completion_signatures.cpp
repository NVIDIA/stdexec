...
TEST_CASE(
  ...
  using set_value_f = _P2300::__q<set_value_sig>;

  using tr = _P2300::__transform<set_value_f, _P2300::__q<_P2300::__types>>;

  using res = _P2300::__minvoke<tr, int, double, string>;
  using expected = _P2300::__types<    //
      ex::set_value_t(int),    //
...
TEST_CASE(
    ...
    "[detail][completion_signatures]") {
  using set_error_f = _P2300::__q1<set_error_sig>;

  using tr = _P2300::__transform<set_error_f, _P2300::__q<_P2300::__types>>;

  using res = _P2300::__minvoke<tr, exception_ptr, error_code, string>;
  using expected = _P2300::__types<           //
...
TEST_CASE(
  ...
  using res = _P2300::__minvoke<tr, exception_ptr>;
  using expected = _P2300::__types<          //
      ex::set_error_t(exception_ptr) //
      >;
  static_assert(is_same_v<res, expected>);
...
TEST_CASE(
  ...
  using err_types_eptr = _P2300::execution::__error_types_of_t<snd_eptr_t>;
  using err_types_ec = _P2300::execution::__error_types_of_t<snd_ec_t>;
  using err_types_str = _P2300::execution::__error_types_of_t<snd_str_t>;
  using err_types_tr_just = _P2300::execution::__error_types_of_t<snd_tr_just_t>;
...
TEST_CASE("__error_types_of_t can also transform error types", "[detail][completion_signatures]") {
  ...
  using set_error_f = _P2300::__q1<set_error_sig>;
  using tr = _P2300::__transform<set_error_f>;

  using sig_eptr = _P2300::execution::__error_types_of_t<snd_eptr_t, ex::no_env, tr>;
  using sig_ec = _P2300::execution::__error_types_of_t<snd_ec_t, ex::no_env, tr>;
  using sig_str = _P2300::execution::__error_types_of_t<snd_str_t, ex::no_env, tr>;

  static_assert(is_same_v<sig_eptr, _P2300::__types<ex::set_error_t(exception_ptr)>>);
  static_assert(is_same_v<sig_ec, _P2300::__types<ex::set_error_t(error_code)>>);
  static_assert(is_same_v<sig_str, _P2300::__types<ex::set_error_t(string)>>);
}

template <typename CS, typename ExpectedValTypes>
void expect_val_types() {
  using t = typename CS::template __gather_sigs<ex::set_value_t, _P2300::__q<_P2300::__types>, _P2300::__q<_P2300::__types>>;
  static_assert(is_same_v<t, ExpectedValTypes>);
}
template <typename CS, typename ExpectedErrTypes>
void expect_err_types() {
  using t = typename CS::template __gather_sigs<ex::set_error_t, _P2300::__q1<_P2300::__id>, _P2300::__q<_P2300::__types>>;
...
TEST_CASE("make_completion_signatures can replicate the completion signatures of input senders",
  ...
  expect_val_types<cs_int, _P2300::__types<_P2300::__types<int>>>();
  expect_val_types<cs_double_char, _P2300::__types<_P2300::__types<double, char>>>();
  expect_val_types<cs_eptr, _P2300::__types<>>();
  expect_val_types<cs_ec, _P2300::__types<>>();
  expect_val_types<cs_stopped, _P2300::__types<>>();

  expect_err_types<cs_int, _P2300::__types<>>();
  expect_err_types<cs_double_char, _P2300::__types<>>();
  expect_err_types<cs_eptr, _P2300::__types<exception_ptr>>();
  expect_err_types<cs_ec, _P2300::__types<error_code>>();
  expect_err_types<cs_stopped, _P2300::__types<>>();
}
...
TEST_CASE("make_completion_signatures can add other error signatures",
  ...
  expect_val_types<cs_with_ec, _P2300::__types<>>();
  expect_err_types<cs_with_ec, _P2300::__types<error_code, exception_ptr>>();
}
...
TEST_CASE("make_completion_signatures can add other error signatures, but will dedup them",
  ...
  expect_err_types<cs_with_ec, _P2300::__types<exception_ptr>>();
}
...
TEST_CASE("make_completion_signatures can add other value signatures",
  ...
  expect_val_types<cs, _P2300::__types<_P2300::__types<int>, _P2300::__types<double>>>();
}
...
TEST_CASE("make_completion_signatures can transform value types signatures",
  ...
  expect_val_types<cs, _P2300::__types<_P2300::__types<int>, _P2300::__types<double>, _P2300::__types<string, double>>>();
}
...
TEST_CASE("make_completion_signatures can transform error types signatures",
  ...
  using cs = ex::make_completion_signatures<snd_double_t, ex::no_env,
      ex::completion_signatures<                        //
          ex::set_error_t(error_code)                   //
          >,                                            //
      _P2300::execution::__compl_sigs::__default_set_value,            //
  ...
  expect_err_types<cs, _P2300::__types<error_code, optional<exception_ptr>>>();
}

template <template <class...> class Variant = _P2300::__types>
...
TEST_CASE("error_types_of_t can be used to get error types",
  ...
  using err_t = ex::error_types_of_t<snd_t, ex::no_env, _P2300::__types>;
  static_assert(is_same_v<err_t, _P2300::__types<>>);
}

TEST_CASE(
    "regression: error_types_of_t can be used to transform error types",
    "[detail][completion_signatures]") {
  using tr = _P2300::__transform<_P2300::__q1<set_error_sig>>;
