...
namespace stdexec {
  ...
  template <typename T>
struct trigger {
    static_assert(sizeof(T) == 0, "The variable __expecting_completion_signatures was used!");
};

template <class _Completions, class _Env>
inline constexpr bool __expecting_completion_signatures = sizeof(trigger<_Completions>) == 0;
