      ...
      static auto get_completion_signatures(_Sender&& __sndr, _Env&& env) {
        ...
        return __sender_apply(
          ...
          []<class _Data, class _Child>(reduce_t tag, _Data data, _Child&& child) {
            ...
            if constexpr (
              stdexec::__valid< LocalTemplates::pls_work_compl_sigs_local, _Child, _Env, _Fun>) {
              return LocalTemplates::pls_work_compl_sigs_local<_Child, _InitT, _Fun>();
