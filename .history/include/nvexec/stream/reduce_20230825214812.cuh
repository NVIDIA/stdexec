  ...
  namespace STDEXEC_STREAM_DETAIL_NS {
    namespace reduce_ {
      ...
      struct sender_t
        ...
        template <class Self, class Env> // constrain?
    ...
    struct reduce_t {
      ...
      using __completion_signatures = //
        __try_make_completion_signatures< _CvrefSender,
         _Env,
      ...
      template <class SenderId, class Self, class Env> // constrain?
      friend auto tag_invoke(get_completion_signatures_t, Self&&, Env&&)
        -> _completion_signatures_t<Self, Env> {
        return {};
      }
      ...
      //       using _Fun = decltype(_Data::__fun_);
      //       using __completion_signatures =
      //         reduce_::sender_t<_Sender, _InitT, _Fun>::template _completion_signatures_t<_Child, _Env>;
