...
static auto get_completion_signatures(_Sender&& __sndr, _Env&& env) {
    return __sender_apply(
      ...
      []<class _Data, class _Child>(reduce_t tag, _Data data, _Child&& child) {
        ...
        using _set_value_local_t = stdexec::completion_signatures<set_value_t(
          ::std::add_lvalue_reference_t< typename nvexec::_strm::__algo_range_init_fun::
                                         binary_invoke_result_t<_Child, _InitT, _Fun>>)>;
        using _set_error_local_t = stdexec::completion_signatures<stdexec::set_error_t(__decay_t<cudaError>&&)>;
        ...
        using pls_work_compl_sigs_local = //
            __try_make_completion_signatures<
                ...
                stdexec::completion_signatures<
                    set_value_t(), //
                    set_stopped_t() >,
                __q<_set_value_local_t>,
                __q<_set_error_local_t> >;
