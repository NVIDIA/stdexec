  ...
  namespace STDEXEC_STREAM_DETAIL_NS {
    ...
    struct reduce_t {
      ...
      using __completion_signatures = //
        __try_make_completion_signatures< _CvrefSender, _Env, stdexec::completion_signatures<stdexec::set_stopped_t()>>;
      ...
      template <class _Ty>
      using _set_error_t = stdexec::completion_signatures<stdexec::set_error_t(__decay_t<cudaError>&&)>;
