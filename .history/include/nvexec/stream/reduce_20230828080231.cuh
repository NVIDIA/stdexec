...
namespace nvexec {
  namespace STDEXEC_STREAM_DETAIL_NS {
    ...
    struct reduce_t {
      ...
      template <class _Child, class _Env> //__decays_to<__basic_sender>
      friend auto tag_invoke(get_completion_signatures_t, _Child&&, _Env&&)
        -> pls_work_compl_sigs<_Child, _Env>
        requires true;
      ...
      friend auto tag_invoke(get_completion_signatures_t, _Child&&, _Env&&, _InitT, _Fun)
        -> pls<_Child, _Env, _InitT, _Env>
        requires true;

      template <class _Child, class _Sender, class _Env> //__decays_to<__basic_sender>
      friend auto tag_invoke(get_completion_signatures_t, _Child&&, _Env&&)
        -> pls<_Child, _Sender, _Env>
        requires true;

      template <class _Child, class _Sender, class _Env> //__decays_to<__basic_sender>
      friend auto tag_invoke(get_completion_signatures_t, _Child&&, _Sender&&, _Env&&)
        -> pls<_Child, _Sender, _Env>
        requires true;
