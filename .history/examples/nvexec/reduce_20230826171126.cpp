...
int main() {
 ...
 // using stdexec::__tag_invoke::tag_invoke;
  ...
  __mtry_eval<__try_value_types_of_t, decltype(snd), test_environment, _SetVal, __q<__ensure_concat> >; //tag_invoke(stdexec::get_completion_signatures, snd, test_env{});
