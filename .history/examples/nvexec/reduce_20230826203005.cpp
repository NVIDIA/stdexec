...
template <class _InitT, class _Fun>
      struct Data {
        ...
        static constexpr auto __mbrs_ = __mliterals<&Data::__initT_, &Data::__fun_>();
      };
      struct Children{};
...
int main() {
  ...
  __mtry_eval<__try_value_types_of_t,
   __basic_sender<test_tag, Data, Children>,
   test_env, set_value_t, __q<__compl_sigs::__ensure_concat> > finished_Type;
