...
int main() {
 ...
 // typename snd_type::__t::_set_value_t set_value_type;
  stdexec::completion_signatures sup = hey;
  stdexec::__compl_sigs::__make_compl_sigs<false> testRun;
  // stdexec::__receivers::set_value_t
  static_assert(stdexec::__completion_signature<stdexec::__receivers::set_value_t>, "No!");
  stdexec::print(sup);
