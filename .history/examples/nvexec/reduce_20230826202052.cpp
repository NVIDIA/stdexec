...
int main() {
  ...
  //using compl = decltype(nvexec::reduce(42.0f));
 // typename compl::_set_value_t<decltype(first), float> set_value_typer;
  ...
  __mtry_eval<__try_value_types_of_t, __basic_sender, test_env, set_value_typer, __q<__ensure_concat> >;
