...
int main() {
  ...
  using eval =  __mtry_eval<__try_value_types_of_t, decltype(snd), __sync_wait,  nvexec::_strm::reduce_t::_set_value_t<decltype(span), float>, __q<__compl_sigs::__ensure_concat>>;
  using stdexec::__tag_invoke::tag_invoke;
